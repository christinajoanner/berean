...
if st.session_state.show_results:
    ...
    with st.expander("Save your analysis"):
        st.text_input("Email", key="user_email", placeholder="you@example.com")
        st.markdown("""
        <div style="font-size:0.75rem;color:rgba(240,240,240,0.5);margin-top:0.5rem;">
          This will be connected to saved deal history once Airtable tracking is enabled.
        </div>
        """, unsafe_allow_html=True)
