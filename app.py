...
/* DEFAULT BUTTON — secondary / ghost outline style */
.stButton > button {{
...
/* PRIMARY BUTTON — bold gold (Streamlit type="primary") */
...
# Buttons: primary gold (Cartagena example) + ghost outlined (run with current values)
b1, b2, b3, _ = st.columns([2, 1.6, 0.4, 4])
with b1:
